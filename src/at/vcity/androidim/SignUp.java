...
public class SignUp extends Activity {
	...
	protected static final int USERNAME_LENGTH_SHORT = 8;
	protected static final int PASSWORD_LENGTH_SHORT = 4;
				...
				{						
						...
						)
					{
						...
						if (passwordText.getText().toString() != null){
							...
							if (usernameText.length() >= 8 && passwordText.length() >= 4) {
									...
									Thread thread = new Thread(){
										...
										public void run() {
											result = imService.signUpUser(usernameText.getText().toString(), 
													passwordText.getText().toString(), result);
								...
								Toast.makeText(getApplicationContext(),R.string.username_length_short, Toast.LENGTH_LONG).show();
								//showDialog(USERNAME_AND_PASSWORD_LENGTH_SHORT);
							}							
						}
						else{
							Toast.makeText(getApplicationContext(),R.string.password_length_short, Toast.LENGTH_LONG).show();
							//showDialog(USERNAME_AND_PASSWORD_LENGTH_SHORT);
						}							
	...
	{    	
		...
		switch (id) 
		{
			...
			case SIGN_UP_SUCCESSFULL:
				...
				.create();	
			case USERNAME_LENGTH_SHORT:
				return new AlertDialog.Builder(SignUp.this)       
				.setMessage(R.string.username_length_short)
				.setPositiveButton(R.string.OK, new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int whichButton) {
						/* User clicked OK so do some stuff */
					}
