...
public class LocalStorageHandler extends SQLiteOpenHelper {
	...
	private static final String DATABASE_NAME = "Waooooh.db";
...
/**	public Cursor fetchTABLE_NAME_MESSAGES(){
		return getReadableDatabase().rawQuery("SELECT" + MESSAGE_SENDER + ", "+MESSAGE_RECEIVER+", "+MESSAGE_MESSAGE+"FROM TABLE_NAME_MESSAGES", new String[0]);
