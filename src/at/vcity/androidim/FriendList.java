...
LazyAdapter adapter;
	...
	{		
		...
		public FriendListAdapter(Context context) {
			...
			mOnlineIcon = BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_profile);
			mOfflineIcon = BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_profile);
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.text.setText("+225" + friends[position].userName);
			holder.icon.setImageBitmap(friends[position].status == STATUS.ONLINE ? mOnlineIcon : mOfflineIcon);
			//holder.icon.setImageBitmap(friends[position].status == STATUS.OFFLINE ? mOfflineIcon );		
	...
	public class MessageReceiver extends  BroadcastReceiver  {
		...
		public void onReceive(Context context, Intent intent) {
			...
			Log.i("De Waooooh ", "Un nouveau message");
	...
	private ServiceConnection mConnection = new ServiceConnection() {
		public void onServiceConnected(ComponentName className, IBinder service) {          
			...
			setTitle("Amis du " + imService.getUsername() );
	...
	public void updateData(FriendInfo[] friends, FriendInfo[] unApprovedFriends)
	{
		...
		if (unApprovedFriends != null) 
		{
			...
			{					
				...
				mBuilder.setContentText("Vous avez une demande d'amitié");
