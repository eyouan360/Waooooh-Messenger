...
import com.chats.ci_waooooh.adapters.DiscussArrayAdapter;
...
public class Messaging extends Activity {
	...
	private DiscussArrayAdapter discussArrayAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		discussArrayAdapter = new DiscussArrayAdapter(getApplicationContext(), R.layout.listitem_discuss);
		
		lv.setAdapter(discussArrayAdapter);
		...
		sendMessageButton.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				{		
                   ...
                   // discussArrayAdapter.add(new OneComment(true, messageText.getText().toString()));
        	        messageText.setText("");
        	        //side = !side;
	...
	public class  MessageReceiver extends BroadcastReceiver {
		...
		{		
			...
			if (username != null && message != null)
			 ...
			 //discussArrayAdapter.registerDataSetObserver(new DataSetObserver() {
				...
				
			{
				MediaPlayer mMediaPlayer = new MediaPlayer();
				  mMediaPlayer = MediaPlayer.create(Messaging.this, R.raw.sms_entrant);
				...
				if (friend.userName.equals(username)) 
				{
					...
					//lv.setAdapter(discussArrayAdapter);
					  ...
					  //discussArrayAdapter.add(new OneComment(false, message));
	        	        //lv.setFilterText(message);
		...
		if (username != null && message != null) {
			...
			if (friend.userName.equals(username)) {
				...
				lv.setAdapter(discussArrayAdapter);
				  ...
				  discussArrayAdapter.add(new OneComment(true, message));
